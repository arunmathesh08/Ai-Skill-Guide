...
export const INITIAL_STUDENT_PROFILE: StudentProfile = {
  ...
  batch: '2022 - 2026',
  cgpa: '8.84 / 10',
  bio: 'Aspiring software engineer focusing on web development, modern cloud architectures, and scalable API systems.',
  careerReadiness: 0,
...
export const CAREER_PATHS: CareerPath[] = [
  {
    ...
    avgSalary: '₹8.5 L – ₹18.0 L / year',
    requiredSkills: [
      { skillName: 'React.js', requiredScore: 75, weight: 1.0 },
      ...
      { skillName: 'Git & Version Control', requiredScore: 65, weight: 1.0 },
      { skillName: 'TypeScript', requiredScore: 65, weight: 1.0 },
    ],
    roadmapSteps: [
  ...
  },
  {
    ...
    avgReadiness: 71,
    demandLevel: 'Critical Demand',
    avgSalary: '₹8.0 L – ₹17.5 L / year',
    requiredSkills: [
      { skillName: 'Node.js', requiredScore: 80, weight: 1.0 },
      { skillName: 'Express.js', requiredScore: 75, weight: 1.0 },
      { skillName: 'REST APIs', requiredScore: 75, weight: 1.0 },
      { skillName: 'SQL & Database Design', requiredScore: 80, weight: 1.0 },
  ...
  },
  {
    ...
    avgReadiness: 56,
    demandLevel: 'Very High',
    avgSalary: '₹9.0 L – ₹20.0 L / year',
    requiredSkills: [
      { skillName: 'Docker & Containers', requiredScore: 75, weight: 1.0 },
      { skillName: 'Kubernetes', requiredScore: 70, weight: 1.0 },
      { skillName: 'CI/CD Pipelines', requiredScore: 75, weight: 1.0 },
      { skillName: 'AWS Infrastructure', requiredScore: 75, weight: 1.0 },
  ...
  },
  {
    ...
    avgReadiness: 62,
    demandLevel: 'Critical Demand',
    avgSalary: '₹9.5 L – ₹22.0 L / year',
    requiredSkills: [
      { skillName: 'Python Programming', requiredScore: 85, weight: 1.0 },
      { skillName: 'Machine Learning', requiredScore: 80, weight: 1.0 },
      { skillName: 'Deep Learning & PyTorch', requiredScore: 75, weight: 1.0 },
      { skillName: 'NLP & Large Language Models', requiredScore: 70, weight: 1.0 },
      { skillName: 'Data Preprocessing', requiredScore: 75, weight: 1.0 },
      { skillName: 'MLOps', requiredScore: 70, weight: 1.0 },
    ],
    roadmapSteps: [
  ...
  },
  {
    ...
    avgReadiness: 76,
    demandLevel: 'High',
    avgSalary: '₹6.5 L – ₹13.0 L / year',
    requiredSkills: [
      { skillName: 'SQL & Queries', requiredScore: 80, weight: 1.0 },
      { skillName: 'Data Analysis', requiredScore: 75, weight: 1.0 },
      { skillName: 'Statistics & Probability', requiredScore: 70, weight: 1.0 },
      { skillName: 'Data Visualization', requiredScore: 75, weight: 1.0 },
      { skillName: 'Business Intelligence', requiredScore: 75, weight: 1.0 },
    ],
    roadmapSteps: [
...
export const MOCK_OPPORTUNITIES: Opportunity[] = [
  ...
  },
  {
    ...
    stipendSalary: '₹9.5 L – ₹12.0 L / year',
  ...
  },
  {
    ...
    isRemote: false,
    location: 'Noida / NCR',
    stipendSalary: '₹8.0 L – ₹10.5 L / year',
